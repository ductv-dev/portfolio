...
export default function Navbar() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-[calc(0.75rem+env(safe-area-inset-bottom))] flex h-full max-h-14 origin-bottom px-2 sm:mb-7 sm:max-h-16 sm:px-4">
